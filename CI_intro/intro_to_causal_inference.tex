...
\note[itemize]{
	...
	\item Rather than direct effect of X-->Y, seek out entire causal mechanisms
}
...
\begin{frame}{Beyond Description}
	\begin{center}
		\LARGE Causal mechanisms allow us to make unbiased predictions about the effect of \textcolor{blue}{\emph{interventions}} and \textcolor{blue}{\emph{counterfactual situations}}
	\end{center}
\end{frame}
